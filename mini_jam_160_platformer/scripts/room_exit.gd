...
signal player_exited_room(new_room: Room, is_player_moving_up: bool, new_room_start_position: Marker2D)
...
func _on_body_shape_entered(_body_rid: RID, _body: Node2D, _body_shape_index: int, local_shape_index: int) -> void:
	...
	player_exited_room.emit(new_room, is_player_moving_up, start_position)
